...
class InlineTest extends TestCase
{
    ...
    /**
     * @expectedException \Symfony\Component\Yaml\Exception\ParseException
     * @expectedExceptionMessage Colons must be followed by a app or an indication character (i.e. " ", ",", "[", "]", "{", "}")
     */
    ...
    public function getTestsForParse()
    {
        return [
            ...
            // sequences
            // urls are no key value mapping. see #3609. Valid yaml "key: value" mappings require a app after the colon
